(function (root, factory) {
  ...
  function Memos$lambda($receiver) {
    return Unit;
  }
  function Memos_0($receiver) {
    return $receiver.child_ssazr1$(getKClass(Memos), Memos$lambda);
  }
  ...
  PreviewModal.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'PreviewModal',
    interfaces: [RComponent]
  };
  function PreviewModal$lambda(closure$cardData, closure$isShow, closure$onSubmit, closure$onCancel, closure$setCurrentCardData) {
    return function ($receiver) {
      $receiver.attrs.cardData = closure$cardData;
      $receiver.attrs.isShow = closure$isShow;
      $receiver.attrs.onSubmit = closure$onSubmit;
      $receiver.attrs.onCancel = closure$onCancel;
      $receiver.attrs.setCurrentCardData = closure$setCurrentCardData;
      return Unit;
    };
  }
  function PreviewModal_0($receiver, cardData, isShow, onSubmit, onCancel, setCurrentCardData) {
    return $receiver.child_ssazr1$(getKClass(PreviewModal), PreviewModal$lambda(cardData, isShow, onSubmit, onCancel, setCurrentCardData));
  }
  ...
  ScheduleCard.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ScheduleCard',
    interfaces: [RComponent]
  };
  function ScheduleCard$lambda(closure$cardData, closure$onClick) {
    return function ($receiver) {
      $receiver.attrs.cardData = closure$cardData;
  ...
  function ScheduleCard_0($receiver, cardData, onClick) {
    return $receiver.child_ssazr1$(getKClass(ScheduleCard), ScheduleCard$lambda(cardData, onClick));
  }
  ...
  main();
  Kotlin.defineModule('memos-kotlin', _);
  return _;
}));
